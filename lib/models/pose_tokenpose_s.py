...
class TokenPose_S(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        if self.use_backbone:
            ...
            self.features = TokenPose_S_base(cfg,image_size=[cfg.MODEL.IMAGE_SIZE[1]//4,cfg.MODEL.IMAGE_SIZE[0]//4],patch_size=[cfg.MODEL.PATCH_SIZE[1],cfg.MODEL.PATCH_SIZE[0]],
